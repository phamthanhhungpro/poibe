...
public static class IdentityApiEndpointRouteBuilderExtensions
{
        ...
        where TUser : class, new()
    {
        ...
        routeGroup.MapPost("/create-user", async Task<Results<Ok, ValidationProblem>>
    ...
    ([FromBody] Logic.Requests.BaseLoginRequest login, [FromServices] IServiceProvider sp) =>
        {
            ...
            var result = await signInManager.PasswordSignInAsync(login.UserName, login.Password, true, lockoutOnFailure: true);
        ...
        accountGroup.MapGet("/info", async Task<Results<Ok<UserInfo>, ValidationProblem, NotFound>>
