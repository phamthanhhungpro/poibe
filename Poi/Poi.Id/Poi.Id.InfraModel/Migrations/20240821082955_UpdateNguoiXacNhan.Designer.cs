...
namespace Poi.Id.InfraModel.Migrations
{
    ...
    [Migration("20240821082955_UpdateNguoiXacNhan")]
    partial class UpdateNguoiXacNhan
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PerEndpointPerFunction", b =>
                {
            ...
            modelBuilder.Entity("PhongBanBoPhanUser", b =>
                {
                    ...
                    b.Property<Guid>("ThanhVienPhongBanId")
                        .HasColumnType("uuid");

                    b.HasKey("ThanhVienId", "ThanhVienPhongBanId");

                    b.HasIndex("ThanhVienPhongBanId");

                    b.ToTable("PhongBanThanhVien", (string)null);
                });

            modelBuilder.Entity("PhongBanBoPhanUser1", b =>
                {
                    b.Property<Guid>("LanhDaoPhongBanId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("QuanLyId")
                        .HasColumnType("uuid");

                    b.HasKey("LanhDaoPhongBanId", "QuanLyId");

                    b.HasIndex("QuanLyId");

                    b.ToTable("PhongBanLanhDao", (string)null);
                });

            modelBuilder.Entity("Poi.Id.InfraModel.DataAccess.AFeedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Poi.Id.InfraModel.DataAccess.AppPermission.PerFunction", b =>
                {
                    ...
                    b.Property<Guid>("GroupFunctionId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Poi.Id.InfraModel.DataAccess.Hrm.HrmChamCongDiemDanh", b =>
                {
                    ...
                    b.Property<Guid?>("HrmCongXacNhanId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Poi.Id.InfraModel.DataAccess.Prj.PrjComment", b =>
                {
                    ...
                    b.Property<string>("NguoiComment")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Poi.Id.InfraModel.DataAccess.Prj.PrjCongViec", b =>
                {
                    ...
                    b.Property<string>("DGChapHanhCheDoThongTinBaoCao")
                        .HasColumnType("text");

                    b.Property<string>("DGChapHanhDieuDongLamThemGio")
                        .HasColumnType("text");

                    b.Property<string>("DGChatLuongHieuQua")
                        .HasColumnType("text");

                    b.Property<string>("DGTienDo")
                        .HasColumnType("text");
                    ...
                    b.Property<Guid?>("LoaiCongViecId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("NgayXacNhanHoanThanh")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Guid?>("NguoiDuocGiaoId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("NguoiGiaoViecId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("TrangThaiChoXacNhan")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Poi.Id.InfraModel.DataAccess.Prj.PrjDuAnSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Poi.Id.InfraModel.DataAccess.Prj.PrjHoatDong", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Poi.Id.InfraModel.DataAccess.Prj.PrjLoaiCongViec", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Poi.Id.InfraModel.DataAccess.TokenExpired", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PrjCongViecPrjTagCongViec", b =>
                {
                    b.Property<Guid>("CongViecId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("TagCongViecId")
                        .HasColumnType("uuid");

                    b.HasKey("CongViecId", "TagCongViecId");

                    b.HasIndex("TagCongViecId");

                    b.ToTable("PrjCongViecPrjTagCongViec");
                });

            modelBuilder.Entity("PrjCongViecUser", b =>
                {
                    b.Property<Guid>("NguoiPhoiHopId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("PrjCongViecId")
                        .HasColumnType("uuid");

                    b.HasKey("NguoiPhoiHopId", "PrjCongViecId");

                    b.HasIndex("PrjCongViecId");

                    b.ToTable("PrjCongViecNguoiPhoiHop", (string)null);
                });

            modelBuilder.Entity("PrjCongViecUser1", b =>
                {
                    b.Property<Guid>("NguoiThucHienId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("PrjCongViec1Id")
                        .HasColumnType("uuid");

                    b.HasKey("NguoiThucHienId", "PrjCongViec1Id");

                    b.HasIndex("PrjCongViec1Id");

                    b.ToTable("PrjCongViecNguoiThucHien", (string)null);
                });
            ...
            modelBuilder.Entity("PerEndpointPerFunction", b =>
                {
                    b.HasOne("Poi.Id.InfraModel.DataAccess.AppPermission.PerEndpoint", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PhongBanBoPhanUser", b =>
                {
                    ...
                    b.HasOne("Poi.Id.InfraModel.DataAccess.PhongBanBoPhan", null)
                        .WithMany()
                        .HasForeignKey("ThanhVienPhongBanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("PhongBanBoPhanUser1", b =>
                {
                    b.HasOne("Poi.Id.InfraModel.DataAccess.PhongBanBoPhan", null)
                        .WithMany()
                        .HasForeignKey("LanhDaoPhongBanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Poi.Id.InfraModel.DataAccess.AppPermission.PerFunction", b =>
                {
                    b.HasOne("Poi.Id.InfraModel.DataAccess.AppPermission.PerGroupFunction", "GroupFunction")
                        .WithMany("Functions")
                        .HasForeignKey("GroupFunctionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Poi.Id.InfraModel.DataAccess.Hrm.HrmChamCongDiemDanh", b =>
                {
                    ...
                    b.HasOne("Poi.Id.InfraModel.DataAccess.Hrm.HrmCongKhaiBao", "HrmCongXacNhan")
                        .WithMany()
                        .HasForeignKey("HrmCongXacNhanId");
            ...
            modelBuilder.Entity("Poi.Id.InfraModel.DataAccess.Prj.PrjCongViec", b =>
                {
                    ...
                    b.HasOne("Poi.Id.InfraModel.DataAccess.Prj.PrjLoaiCongViec", "LoaiCongViec")
                        .WithMany("CongViec")
                        .HasForeignKey("LoaiCongViecId");

                    b.HasOne("Poi.Id.InfraModel.DataAccess.User", "NguoiDuocGiao")
                        .WithMany()
                        .HasForeignKey("NguoiDuocGiaoId");

                    b.HasOne("Poi.Id.InfraModel.DataAccess.User", "NguoiGiaoViec")
                        .WithMany()
                        .HasForeignKey("NguoiGiaoViecId");
            ...
            modelBuilder.Entity("PrjCongViecPrjTagCongViec", b =>
                {
                    b.HasOne("Poi.Id.InfraModel.DataAccess.Prj.PrjCongViec", null)
                        .WithMany()
                        .HasForeignKey("CongViecId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PrjCongViecUser", b =>
                {
                    b.HasOne("Poi.Id.InfraModel.DataAccess.User", null)
                        .WithMany()
                        .HasForeignKey("NguoiPhoiHopId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Poi.Id.InfraModel.DataAccess.Prj.PrjCongViec", null)
                        .WithMany()
                        .HasForeignKey("PrjCongViecId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Poi.Id.InfraModel.DataAccess.Prj.PrjDuAnNvChuyenMon", b =>
                {
                    ...
                    b.Navigation("TagComment");

                    b.Navigation("TagCongViec");
                });
